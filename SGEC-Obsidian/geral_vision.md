...
## Qual o objetivo do projeto?
  ...
  - Caixa: O Caixa é um módulo que visa em ser uma interface para registrar as vendas efetuadas no Balcão (enquanto ele existir), assim permitindo o rastreamento de vendas e registros mais detalhados. Mas principalmente, centralizar os relatórios de entradas monetárias.

  - Financeiro: O Financeiro seria um módulo apenas para uso da Adriana (responsável pelo financeiro da empresa), suas funcionalidades ainda precisam ser discutidas.
